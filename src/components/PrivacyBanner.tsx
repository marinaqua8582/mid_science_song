    ...
    <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-xs md:text-sm text-amber-900 shadow-sm transition-all mb-6">
      <div className="flex items-start gap-3">
        ...
        <div className="space-y-1 leading-relaxed">
          ...
          <p>
            수행평가 참여 확인을 위해 학년, 반, 번호, 이름과 교사가 등록한 Google ID를 사용합니다. Google ID는 학생이 Suno AI에 로그인할 계정을 확인하는 용도로만 본인 화면에 표시되며, 제출 내용에는 저장하지 않습니다. 학생 식별정보는 과학송 가사 생성을 위한 Gemini AI에 전달되지 않고, 교사가 관리하는 Google Sheets에 수행평가 확인 목적으로 저장됩니다. 수집된 정보는 평가 및 성적 확인이 끝난 후 삭제합니다. 학습 내용과 AI 요청사항에는 자신이나 다른 사람의 개인정보를 입력하지 마세요.
          </p>
        </div>
      </div>
    </div>
