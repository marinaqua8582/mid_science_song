...
import {
  ...
  GraduationCap, Check, ShieldCheck, Database
} from 'lucide-react';
...
export default function App() {
  ...
  const handleStudentLogout = () => {
    if (confirm('로그아웃 하시겠습니까? 입력 중인 내용은 저장됩니다.')) {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-slate-900 text-base sm:text-lg leading-tight flex items-center gap-2">
                Science Song 수행평가
                <span className="text-[10px] px-2 py-0.5 bg-blue-50 text-blue-700 font-bold rounded border border-blue-200 hidden sm:inline-block">
                  중학교 과학
                </span>
              </h1>
